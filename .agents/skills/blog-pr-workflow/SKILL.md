...
- PR을 만들 때 허용되는 브랜치 prefix는 `feat-`, `fix-`, `refac-`, `docs-`, `chore-`, `test-`, `style-`, `perf-`, `hotfix-`다.
...
- PR 제목 type과 브랜치 prefix가 일치해야 한다. 단, `hotfix-*` 브랜치의 PR 제목 type은 `fix`로 허용한다. 불일치하면 브랜치명 수정 또는 PR 제목 type 수정을 사용자에게 요청한다.
