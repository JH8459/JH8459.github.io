...
- `.codex/skills/blog-pr-workflow/SKILL.md`: PR 기반 커밋, push, PR 작성 워크플로우
- `.codex/skills/blog-review-workflow/SKILL.md`: 리뷰 요청 시 사용할 통합 리뷰 워크플로우
- `.codex/skills/blog-docs-update/SKILL.md`: 변경 사항에 맞춘 문서 정합성 갱신 스킬
- `.codex/skills/blog-publish-workflow/SKILL.md`: 공개 페이지, 포스트, SEO, 게시 흐름 수정 스킬
...
- 커밋, push, PR 작성은 기본적으로 `.codex/skills/blog-pr-workflow/SKILL.md`의 PR 기반 절차를 따릅니다.
- 사용자가 명시적으로 PR 없는 직접 반영을 요청할 때만 `.codex/skills/blog-commit-workflow/SKILL.md`를 사용합니다.
