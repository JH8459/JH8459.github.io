...
지금은 설계나 코드 구조를 검토할 때 AI에게 먼저 질문해보며 위험 요소를 빠르게 점검할 수 있지만, 당시에는 그런 도움을 받을 수 있는 도구도 없었다.   그래서 잘못된 선택을 했을 때 이를 되돌릴 기준조차 마련하기 어려웠고, 혼자 성장해야 한다는 부담이 훨씬 크게 다가왔다.
...
1. **혼자 하지 말 것 — 학습은 피드백의 속도로 결정된다**
    ...
    초기에는 그것이 반드시 훌륭한 동료 개발자라고 생각했지만, 지금은 조금 다르게 생각한다.

    최근에는 AI Agent도 초기 피드백을 제공해주는 중요한 도구가 되고 있다.  
    사람이 놓치기 쉬운 예외나 대안 설계를 빠르게 제시해주어, 본격적인 리뷰에 앞서 사고 범위를 넓히는 데 도움을 준다.  
    물론 최종 판단은 사람이 해야 하지만, 피드백을 받는 과정 자체가 예전보다 훨씬 짧아졌다는 점은 분명한 변화다.
...
요즘은 이러한 기본기에 더해, AI Agent가 제안하는 방향을 검증하고 해석하는 능력까지 필요해지고 있다. AI가 많은 부분을 도와줄 수 있게 되었지만, 결국 어떤 선택을 할지 판단하는 기준은 개발자가 직접 세워야 한다는 점을 다시 느끼게 된다.
