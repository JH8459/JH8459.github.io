export const title = `blog.jh8459.com`;
export const description = `JH 개발일기`;
export const language = `ko`;
export const siteUrl = `https://blog.jh8459.com`;
...
export const trakingId = 'G-B02DJ4ZW5E';
export const publisherId = 'ca-pub-5947324447654662';
export const author = {
  name: `김정현`,
  bio: {
    role: `백엔드 개발자`,
