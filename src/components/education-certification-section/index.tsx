...
import type { CertificationItem, EducationItem } from '../../types/about';

interface EducationCertificationSectionProps {
  education?: EducationItem[];
  certifications?: CertificationItem[];
}

/**
 * @description 학력 및 자격증 섹션
 * @param {EducationCertificationSectionProps} props 섹션 props
